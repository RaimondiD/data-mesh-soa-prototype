...
public class ClientForTesting {
    ...
    private static SQLInsertQuery CreateInsertSqlQuery() {
        ...
        ArrayList<String> columnNames = new ArrayList<String>(Arrays.asList("prescription_code", "civ", "priority", "medic_civ", "description",
    ...
    public static SQLSelectQuery CreateSelectSqlQuery(){
        ...
        return new SQLSelectQuery("medicalprescription", allColumn, noCcondition);
    }
}
