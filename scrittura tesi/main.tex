...
\usepackage[pdfa, colorlinks = false]{hyperref}
\usepackage{float}
\usepackage{setspace}
...
Di norma, un team di data engineer si occupa della gestione e della raccolta dei dati dalle fonti, di effettuare eventuali trasformazioni per rimuovere errori o per adattare i dati a uno schema preciso e infine di salvarli nel punto di raccolta.
