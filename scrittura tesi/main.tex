...
In \cite{designChoiche}, viene individuato come problema principale per l'evoluzione di un'architettura la così detta ``knowledge vaporization'', intesa come la mancanza di documentazione dei motivi che hanno portato ad una specifica modifica al sistema. %%todo: mostro ad altea
